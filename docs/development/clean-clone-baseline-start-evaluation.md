...
`@traefik` now points at the canonical `service-lasso/lasso-traefik@2026.4.27-354433e` release artifact. The command can acquire, configure, and start Traefik as a real release-backed baseline service.
