...
| `@traefik` | `service-lasso/lasso-traefik` | release-backed managed router service | yes | Current verified release is `2026.4.27-41ef504`. |

Current Traefik release:

- Repo: `https://github.com/service-lasso/lasso-traefik`
- Release: `https://github.com/service-lasso/lasso-traefik/releases/tag/2026.4.27-41ef504`
...
- repo exists
- releases exist
- core manifest points at `service-lasso/lasso-traefik@2026.4.27-41ef504`
...
- `lasso-traefik` remains aligned with the shared service repo contract; current proof is release `2026.4.27-41ef504` with checksum output, HTTP `/ping` readiness, env/globalenv outputs, the full service-port map, and donor-compatible `portmapping`.
