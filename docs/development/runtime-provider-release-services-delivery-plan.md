...
| `@traefik` | `service-lasso/lasso-traefik` | release-backed managed router service | yes | Current verified release is `2026.4.27-a266e3e`. |

Current Traefik release:

- Repo: `https://github.com/service-lasso/lasso-traefik`
- Release: `https://github.com/service-lasso/lasso-traefik/releases/tag/2026.4.27-a266e3e`
...
- repo exists
- releases exist
- core manifest points at `service-lasso/lasso-traefik@2026.4.27-a266e3e`
...
- `lasso-traefik` remains aligned with the shared service repo contract; current proof is release `2026.4.27-a266e3e` with checksum output, HTTP `/ping` readiness, env/globalenv outputs, and the full service-port map.
