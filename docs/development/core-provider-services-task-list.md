...
| `@python` | `lasso-python-3.11.5-win32.zip`, `lasso-python-3.11.5-linux.tar.gz`, `lasso-python-3.11.5-darwin.tar.gz`, `lasso-python-3.14.4-win32.zip`, `lasso-python-3.14.4-linux.tar.gz`, `lasso-python-3.14.4-darwin.tar.gz` |
