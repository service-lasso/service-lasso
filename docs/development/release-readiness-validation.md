...
- Current state: execution in progress with core package, external consumer smoke, service acquisition, Echo Service, Service Admin, reference-app template evidence, live reference-app lifecycle evidence, and failure/lifecycle smoke evidence captured; remaining pending rows stay explicit below
