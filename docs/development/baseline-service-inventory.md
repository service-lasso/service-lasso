...
Linked issues: `#89`, `#91`, `#97`, `#102`, `#158`, `#159`, `#171`, `#172`, `#185`, `#187`, `#189`
...
| `@traefik` | Release-backed baseline edge/router service with HTTP `/ping` readiness plus local `env` and shared `globalenv` outputs for the full Traefik service-port map. | Downloads from `service-lasso/lasso-traefik@2026.4.27-a266e3e` during install. |
