...
- `service-lasso install localcert`, `service-lasso install @node`, `service-lasso install @traefik`, `service-lasso install echo-service`, and `service-lasso install service-admin` must acquire their configured release artifacts
