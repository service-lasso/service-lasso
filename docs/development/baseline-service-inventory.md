...
Linked issues: `#89`, `#91`, `#97`, `#102`, `#158`, `#159`, `#171`, `#172`, `#185`
...
| `@traefik` | Release-backed baseline edge/router service with HTTP `/ping` readiness on the admin entrypoint. | Downloads from `service-lasso/lasso-traefik@2026.4.27-38bd54d` during install. |
