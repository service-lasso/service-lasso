...
- `docs/development/core-runtime-package-architecture.md` - bounded package-boundary plan and current `packages/` workspace scaffold for the core runtime plus future reference-app templates
