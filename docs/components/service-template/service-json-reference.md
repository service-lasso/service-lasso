...
Every check must have a stable `id` that is unique within the service manifest.

### Observed donor `healthchecks[]` item types
The donor runtime/code shows these readiness check types:
- `http`
- `tcp`
- `file`
- `variable`
...
- explicit `env`
- explicit `depend_on`
- top-level `healthchecks[]` with stable check ids
...
[Component guides](../README.md) · Imported from [service-template](https://github.com/service-lasso/service-template/blob/023b76bb2836f3c0e59c870407fd71a4e2e73f88/docs/service-json-reference.md). The [migration inventory](../documentation-migration.md) records ownership and remaining work.
