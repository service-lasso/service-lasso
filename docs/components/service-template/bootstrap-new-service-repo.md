...
[Component guides](../README.md) · Imported from [service-template](https://github.com/service-lasso/service-template/blob/023b76bb2836f3c0e59c870407fd71a4e2e73f88/docs/bootstrap-new-service-repo.md). The [migration inventory](../documentation-migration.md) records ownership and remaining work.
