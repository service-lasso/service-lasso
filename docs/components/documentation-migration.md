...
| Other service and app-template repositories | Historical develop-branch and Markdown inventory covers 42 repositories, with 19 unavailable trees in that snapshot | [Core #1282](https://github.com/service-lasso/service-lasso/issues/1282) owns fresh availability checks, guide classification, remaining migrations and source redirects |
