...
| --- | --- | --- |
| Core | `2026.9.11-462f837` | `462f837b25224e98103296b4597807b5beea00c5` |
...
| npm | `@service-lasso/service-lasso@2026.9.11-462f837` | Same Core revision |

Expected Windows SHA-256 values:

| Artifact | SHA-256 |
| --- | --- |
| Core lean ZIP | `3b140d33537b8fb902506797d37940d6647547e46d9bfa56b908d0acb69eb9cb` |
| Core bundled ZIP | `5fe6210a7d068b0837406dd99fbb2bf32d4d3c05fb12997c807e32be63cff065` |
...
```powershell
Invoke-WebRequest `
  -Uri 'https://github.com/service-lasso/service-lasso/releases/download/2026.9.11-462f837/service-lasso-2026.9.11-462f837-win32.zip' `
  -OutFile 'service-lasso-2026.9.11-462f837-win32.zip'

Invoke-WebRequest `
  -Uri 'https://github.com/service-lasso/service-lasso/releases/download/2026.9.11-462f837/service-lasso-bundled-2026.9.11-462f837-win32.zip' `
  -OutFile 'service-lasso-bundled-2026.9.11-462f837-win32.zip'
...
$ExpectedHashes = [ordered]@{
  'service-lasso-2026.9.11-462f837-win32.zip' =
    '3b140d33537b8fb902506797d37940d6647547e46d9bfa56b908d0acb69eb9cb'
  'service-lasso-bundled-2026.9.11-462f837-win32.zip' =
    '5fe6210a7d068b0837406dd99fbb2bf32d4d3c05fb12997c807e32be63cff065'
...
npm init -y
npm install --ignore-scripts '@service-lasso/service-lasso@2026.9.11-462f837'
...
- CLI version: `2026.9.11-462f837`;
- npm `latest`: `2026.9.11-462f837`;
- `gitHead`: `462f837b25224e98103296b4597807b5beea00c5`;
...
Expand-Archive `
  -LiteralPath (Join-Path $DownloadRoot 'service-lasso-bundled-2026.9.11-462f837-win32.zip') `
  -DestinationPath $BundleExtractRoot

$BundleRoot = Join-Path $BundleExtractRoot 'service-lasso-bundled-2026.9.11-462f837'
...
Expand-Archive `
  -LiteralPath (Join-Path $DownloadRoot 'service-lasso-2026.9.11-462f837-win32.zip') `
  -DestinationPath $CoreExtractRoot

$CoreRoot = Join-Path $CoreExtractRoot 'service-lasso-2026.9.11-462f837'
...
- Core status is `ok`;
- Core API version is `2026.9.11-462f837`;
