...
Start with the [Beginner Todo app](getting-started/beginner-todo-app.md), the [durable PostgreSQL step](getting-started/make-todo-app-durable.md), or the [Admin demo](quick-start.md). Make one change, then repeat the same success check you used before the change.
