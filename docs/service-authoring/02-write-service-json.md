...
- `rerun: "ifChanged"` reruns when declared `fingerprint` inputs or the installed artifact release tag change. Setup state stores a hash only, never the resolved values.
