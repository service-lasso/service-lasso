...
- Primary path: [Beginner Todo app](getting-started/beginner-todo-app.md), then [make it durable with PostgreSQL](getting-started/make-todo-app-durable.md), then [package it](package-your-app.md).
