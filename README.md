...
| `npm run demo:recycle -- --port=17883` | Acquire the canonical lane lock, then exactly stop → confirm stopped → start from the current built checkout → verify. |
