...
- Keep Release 1 promotion blocked until issue `#1151` contains a named
  independent security approval for the exact replacement packet and immutable
  Core/npm `2026.9.11-462f837` identities; internal evidence assembly is not
  external sign-off. The reject of `2026.9.1-1f4ec40` remains in force for that
  older identity.
