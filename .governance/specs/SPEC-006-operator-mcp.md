...
- Release qualification, packaged conformance, and canonical acceptance (`#864`)
...
- The later `#864` slice adds packaged-app, conformance, Inspector, and canonical evidence.
