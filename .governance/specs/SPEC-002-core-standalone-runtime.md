...
- `AC-4D`: The runtime can optionally wait for bounded startup readiness using manifest health retry fields so start/restart flows can distinguish "process launched" from "service became ready".
